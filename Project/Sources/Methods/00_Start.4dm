...
Case of 
	...
	Else 
		...
		$options.title:="use collections in form objects?"
		
		$options.blog:="blog.4d.com"
		$options.info:="4D interface"  //ex : "4D View Pro feature"
		
		$options.minimumVersion:="1900"  // 1840 means 18R4   1804 means 18.4 (do not use !)
